...
public class swerve_no_g extends Command {
...
private double turn2;
  ...
  public swerve_no_g(drive d_drive, Supplier<Double> d_axes1, Supplier<Double> d_axes2, Supplier<Double> d_axes3,Supplier <Boolean> d_button) {
...
s_drive.swerve(degrees, speed, turn2,degrees);
