...
public class swerveback extends Command {
...
private double turn2;
  ...
  public swerveback(drive d_drive, Supplier<Double> d_axes1, Supplier<Double> d_axes2, Supplier<Double> d_axes3,Supplier <Boolean> d_button) {
...
s_drive.swerve(degrees+180, speed, turn2,degrees);
