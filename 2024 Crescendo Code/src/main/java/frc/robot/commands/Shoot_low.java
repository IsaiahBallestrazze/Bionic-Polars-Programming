...
public class Shoot_low extends Command {
  /** Creates a new Shoot. */
  private final Intake2 s_Intake2;

  private double Flyspeed = .15;
  private double Inspeed = .5;
  private double Chamspeed = .5;
  ...
  public Shoot_low(Intake2 d_Intake2, NeoPixels dPixels) {
